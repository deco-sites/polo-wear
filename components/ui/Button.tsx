...
const variants = {
  primary:
    "h-[36px] px-3 text-white rounded bg-black font-button border-transparent active:bg-interactive active:text-default-inverse active:border-transparent disabled:border-default disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none ",
