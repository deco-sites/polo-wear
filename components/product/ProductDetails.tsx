            ...
            <div class="flex flex-col items-center lg:flex-row lg:gap-2 lg:justify-between">
              <div class="flex gap-2 max-w-full lg:max-w-[450px] flex-col lg:flex-row justify-center items-center">
                ...
                <div class="flex self-start gap-4 lg:flex-col">
                  {[front, back ?? front].map(image => <button class="border border-light-border rounded-xl p-2" onClick={() => currentImage.value == 0 ? currentImage.value = 1 : currentImage.value = 0}><Image src={image.url!} width={50} height={60}/></button>)}
                </div>
              </div>
              {/* Product Info */}
              <div class=" flex gap-8 flex-col lg:justify-between items-center px-4 sm:px-0">
                ...
                <div class="mt-4">
                  <div class="flex flex-row gap-2 items-center">
                    ...
                    <Text tone="price" variant="heading-3" class="!font-semibold !text-[30px]">
                ...
                <Input buttonText="OK" label="Calcule o frete e prazo de entrega" link={{href: "#", text: "Não sei meu CEP"}}  />
              </div>
          </div>
          {/* Description card */}
